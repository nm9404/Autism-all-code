...
def preprocessing_function(args):
    ...
    if os.path.exists(subject_path+'/'+elastic_sub_output):

        shutil.copyfile(subject_path+'/'+elastic_sub_output, 
            subject_path+'/-th025-'+elastic_sub_output)

        shutil.copyfile(subject_path+'/'+elastic_cortical_output, 
            subject_path+'/-th025-'+elastic_cortical_output)
