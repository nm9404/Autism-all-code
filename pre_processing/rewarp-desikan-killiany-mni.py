...
def preprocessing_function(args):
    ...
    seg_output='destrieux_seg.nii.gz'
...
if __name__=='__main__':
    data_file_path='/mnt/md0/nmunerag/Autismo/TABLA_MNI.csv'
    processed_path='/mnt/md0/ABIDE_PREP'
    brain_template_path='/mnt/md0/nmunerag/Herramientas/atlas/MNI152_T1_1mm_brain.nii.gz'
    seg_path='/mnt/md0/nmunerag/Herramientas/atlas/atlas_destrieux.nii.gz'
