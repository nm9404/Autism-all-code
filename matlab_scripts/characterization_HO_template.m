...
table_name='HO';
regions_data=readtable('HO/labels_ho_cort.csv');
regions=height(regions_data)



characterization_path='characterization-HO';
...
for i=1:num_subjects
    ...
    try 
        volume_struc=load_untouch_nii('HO/MNI152_T1_1mm_brain.nii.gz');
    
        regions_seg_struc=load_untouch_nii('HO/HarvardOxford-cortl-maxprob-thr0-1mm.nii.gz');
    catch exception
