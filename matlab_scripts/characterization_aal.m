...
seg_path='/mnt/md0/nmunerag/Herramientas/atlas/labels_aal_transformed.csv';
regions_table = readtable(seg_path);
regions_indices = uint16(cell2mat(table2cell(regions_table(:, 3))));
