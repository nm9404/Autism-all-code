...
table_name='level2-mask-curvature';
regions_data=readtable('curvature_exp/white.csv');
regions=height(regions_data)



characterization_path=['characterization_', table_name];
...
for i=1:num_subjects
    ...
    try 
        volume_struc=load_untouch_nii('curvature_exp/white-matter-mask.nii.gz');
    
        regions_seg_struc=load_untouch_nii('curvature_exp/white-matter-mask.nii.gz');
    catch exception
