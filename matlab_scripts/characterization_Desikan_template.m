...
table_name='Desikan';
regions_data=readtable('DESIKAN/desikan_labels.csv');
regions=height(regions_data)



characterization_path='characterization-Desikan';
...
for i=1:num_subjects
    ...
    try 
        volume_struc=load_untouch_nii('DESIKAN/brain.nii.gz');
    
        regions_seg_struc=load_untouch_nii('DESIKAN/desikan.nii.gz');
    catch exception
