...
table_name='ONPRC18';
regions_data=readtable('ONPRC18/ONPRC18_names.csv');
regions=height(regions_data)



characterization_path='characterization-ONPRC18';
...
for i=1:num_subjects
    ...
    try 
        volume_struc=load_untouch_nii('ONPRC18/ONPRC18_T1W.nii.gz');
    
        regions_seg_struc=load_untouch_nii('ONPRC18/ONPRC18_GrayMatterLabelmapCondensed.nii.gz');
    catch exception
