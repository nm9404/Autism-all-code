...
characterization_path='characterization-13-sep-aal-combined-difs';

pipeline_name='pip-spm-ants-rotation';
init_path='/mnt/md0/ABIDE_PREP';

volume_name='rigid_reg_tempWarped_z_norm.nii.gz';
segmentation_name='aal_difs_comb_seg.nii.gz';
segmentation_orig_name='aal_seg_comb.nii.gz';
...
seg_path='/mnt/md0/nmunerag/Herramientas/atlas/differences_ho_aal_combined.csv';
orig_seg_path='/mnt/md0/nmunerag/Herramientas/atlas/aal_combined.csv';

regions_table = readtable(seg_path);
regions_table_orig = readtable(orig_seg_path);

orig_indices =    [1, 2, 3, 3,  3,  4, 4,  4,  5, 6, 7, 8,8,8, 9,9, 9, 10,10,11,11,12,12,13];
